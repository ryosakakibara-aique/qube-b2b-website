    ...
    <main className="min-h-screen overflow-hidden bg-[var(--background)] text-[var(--heading)]">
      ...
      <section className="mx-auto grid min-h-[356px] w-full max-w-[1040px] gap-8 px-6 py-16 lg:grid-cols-2 lg:px-0 lg:py-[120px]">
        <div className="max-w-[508px]">
          ...
          <Link
            href="#contact"
            className="cta-gradient mt-8 inline-flex h-11 items-center rounded-[var(--radius-control)] px-6 text-sm font-bold text-[var(--brand-foreground)] transition-opacity hover:opacity-90 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[var(--focus-ring)]"
          >
            Talk to an Expert
          </Link>
        </div>
        ...
        <div className="mt-8 grid grid-cols-1 overflow-hidden rounded-[var(--radius-card-sm)] border border-[var(--border-subtle)] sm:grid-cols-2 lg:grid-cols-3">
          {businessFeatures.map(([title, body]) => (
            ...
            >
              ...
              <p className="mt-3 text-sm leading-5 text-[var(--text-muted)]">{body}</p>
            </article>
          ))}
        </div>
      </section>
      ...
      <section className="mx-auto max-w-[1040px] px-6 py-20 text-center lg:px-0 lg:py-28">
        ...
        <Link
          href="#contact"
          className="cta-gradient mt-6 inline-flex rounded-[var(--radius-control)] px-6 py-3 text-sm font-bold text-[var(--brand-foreground)] transition-opacity hover:opacity-90 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[var(--focus-ring)]"
        >
          Talk to an Expert
        </Link>
      </section>
